...
namespace ToDoList
{
    public class ToDoListShould
    {
        ...
        {
            list.AddEntry(33, userA, "Do nothing", 100);
            list.RemoveEntry(33, userB, 105);
            list.MarkDone(33, userA, 110);
            
            list.AddEntry(33, userA, "Do nothing", 115);

            AssertEntries(Entry.Done(33, "Do nothing"));
        }
